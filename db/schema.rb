...
ActiveRecord::Schema[8.1].define(version: 2026_05_23_100002) do
  ...
  create_table "course_registrations", force: :cascade do |t|
    ...
    t.index ["participant_id", "course_id"], name: "index_course_registrations_unique_active", unique: true, where: "((status)::text <> ALL ((ARRAY['storniert'::character varying, 'ausstehend'::character varying])::text[]))"
