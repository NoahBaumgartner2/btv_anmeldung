...
ActiveRecord::Schema[8.1].define(version: 2026_08_23_174304) do
  ...
  create_table "course_access_grants", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.string "status", default: "eingeladen", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "courses", force: :cascade do |t|
    ...
    t.boolean "allows_late_registration_deduction", default: true, null: false
  ...
  create_table "training_sessions", force: :cascade do |t|
    ...
    t.bigint "attendance_confirmed_by_id"
    t.text "cancellation_reason"
    t.bigint "course_id", null: false
    t.datetime "created_at", null: false
    t.datetime "end_time"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.jsonb "admin_notification_preferences", default: {}, null: false
    t.string "city"
    ...
    t.string "nationality", default: "CH"
    t.string "phone_number"
    t.datetime "photo_consent_accepted_at"
